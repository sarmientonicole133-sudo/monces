...
<div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center mb-8">
        <div class="sm:flex-auto">
            <h1 class="text-3xl font-bold text-white" data-aos="fade-right">Create Product</h1>
            <p class="mt-2 text-lg text-gray-300" data-aos="fade-right" data-aos-delay="100">Add a new product to your inventory</p>
        </div>
    </div>
            ...
            <div class="bg-black bg-opacity-55 rounded-xl shadow-lg p-8" data-aos="fade-up">
                <div class="md:grid md:grid-cols-3 md:gap-8">
                    <div class="md:col-span-1">
                        ...
                        <p class="mt-2 text-base text-gray-300">General information about the product</p>
                    </div>
                    ...
                    <div class="mt-6 md:mt-0 md:col-span-2">
                        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full rounded-lg border-gray-600 bg-gray-800 text-white shadow-sm focus:border-red-500 focus:ring-red-500 py-3 px-4">
                                @error('name')
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="4" class="w-full rounded-lg border-gray-600 bg-gray-800 text-white shadow-sm focus:border-red-500 focus:ring-red-500 py-3 px-4">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative rounded-lg shadow-sm">
                                    ...
                                    <input type="number" name="price" id="price" value="{{ old('price') }}" step="0.01" min="0" class="block w-full pl-7 pr-12 rounded-lg border-gray-600 bg-gray-800 text-white focus:border-red-500 focus:ring-red-500 py-3 px-4">
                                </div>
                                @error('price')
                                    <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="stock" id="stock" value="{{ old('stock', 0) }}" min="0" class="w-full rounded-lg border-gray-600 bg-gray-800 text-white shadow-sm focus:border-red-500 focus:ring-red-500 py-3 px-4">
                                @error('stock')
                                    <p class="mt-2 text-sm text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
